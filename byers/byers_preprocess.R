...
data <-
  range_speedread("1B3UzqR0yOsUZVVjjhgvMuxfIHiDPd8atgchxwcZP2-Y",range="Projects") %>% 
...
data_countries <-
  range_speedread("1B3UzqR0yOsUZVVjjhgvMuxfIHiDPd8atgchxwcZP2-Y",range="Countries", col_names = FALSE)
